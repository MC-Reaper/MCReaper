    ...
    async def sysinfo(self, ctx):
        ...
        try:
            ...
            try:
                ...
                await ctx.send(content="I have downloaded a neofetch binary, please run this command again.")
            except:
            	await ctx.send("There is no neofetch binary and I could not download one!")
