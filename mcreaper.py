...
# --------------------------------------------------------------------------
BOT_VERSION = f'Python: v{python_version()} | Discord.py: v{discord.__version__} | Bot: v0.17'
...
CHANGELOG_MESSAGE = "Added listsudo command for bot owners."
CHANGELOG_DATE = '17/02/2021'
# ! DO NOT EDIT !
# ---------------------------------------------------------------------------
